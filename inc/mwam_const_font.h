...
const uint8_t kNumGlyphs = 102; // 96 ASCII 0x20..0x7F plus 6 ÄÖÜäöü
const uint8_t kRowsPerGlyph = 7;
const uint8_t kGlyphSpacing = 2;

static const glyph_t kFontGlyphs[kNumGlyphs] = {
